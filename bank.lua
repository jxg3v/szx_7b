...
xname =  (Redis:get(Fast.."Name:Bot") or "[ 𝗔𝗕𝗨 𝗜𝗔𝗡]") 
...
data = {
{
{text = '✦ َ 𝗔𝗕𝗨 𝗜𝗔𝗡• 𝙎َِ𝙊َِ𝙐َِ𝙍َِ𝘾َِ𝙀ِ ✦', url="t.me/COURSE_ABUIAN"},
},
}
}
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@COURSE_ABUIAN")
sleep(1)
