...
local input_message_content = {message_text = 'هذي الهمسة للحلو ( [@'..username[2]..'] ) هو اللي يكدر يشوفهه حب🗿🔥🔐', parse_mode = 'Markdown'}	
...
if tonumber(Message_Edit.sender_id.user_id) == 5099564264 then
data.The_Controller = 1
elseif tonumber(Message_Edit.sender_id.user_id) == 5099564264 then
data.The_Controller = 1
...
if tonumber(IdUser) == 5099564264 then
data.The_Controller = 1
elseif tonumber(IdUser) == 5099564264 then
data.The_Controller = 1
