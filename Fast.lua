...
io.write('\27[1;31m دزلي توكن البوت هسه\nSend Me a Bot Token Now ↡\n\27[0;39;49m')
local TokenBot = io.read()
if TokenBot and TokenBot:match('(%d+):(.*)') then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getMe')
local Json_Info = JSON.decode(url)
if res ~= 200 then
print('\27[1;34mحبيبي توكن البوت خطاء ارجع دزه عدل\nBot Token is Wrong\n')
else
...
print('\27[1;34mمانحفض التوكن جرب مره ثانيه \nToken not saved, try again')
end 
os.execute('lua5.2 Fast.lua')
end
if not Redis:get(SshId.."Info:Redis:User") then
io.write('\27[1;31mحب دزلي معرف المطور الاساسي هسه \nDeveloper UserName saved ↡\n\27[0;39;49m')
...
io.write('\27[1;31mهسه دز ايدي المطور الاساسي \nDeveloper ID saved ↡\n\27[0;39;49m')
...
if UserId == 5099564264 then
Status = 'المبرمچ ابو ايان🔥'
elseif UserId == 5099564264 then
...
num = {"هاذ حجيه كله جذب ب جذب💔😔"," هاذ مظبوط🙂😹"," اكلك شي انت جذاب ولي كلالك جذاب ولي يشاهد هم جذاب??😂"," هاذ زلمه كلف واثق منه هم❤️😁","فعلً كلامك صحيح🤗","يمعود لجذب شبيك😹","احس كلامه صحيح 🌚💕","طيب باوع عين بعين هيج??","انت صح",};
sendnum = num[math.random(#num)]
sl = ' ⟨  '..text..'  ⟩ \n '..sendnum..' '
