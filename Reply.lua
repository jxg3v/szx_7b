...
data = {
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝗔𝗕𝗨 𝗜𝗔𝗡', url = 't.me/COURSE_ABUIAN}, 
},
}
}
return send(msg_chat_id,msg_id,'*هآي تع اشرب شااي • 😹💔*',"md",false, false, false, false, reply_markup)
end
...
if text == 'اجيت' or text == 'انا جيت' then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'*هاه يروحييحبيب*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*اححح ياا🙂🪓*',"md",false, false, false, false, reply_markup)
end
